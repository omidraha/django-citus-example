"""
Django settings for citus_exp project.
...
WSGI_APPLICATION = 'citus_exp.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'HOST': os.environ.get('DATABASES_HOST', '192.168.0.130'),  # '127.0.0.1'
